Feature:Step2 and 4 new design inluding secure logos
...
#mileage button
		 #And I select a button for the number of kilometers driven per year"<kilometersDriven>"
...
#New step 2 page
		...
		And I click Car and Key Rescue add button
		And I click Open Driving  add button
		And I click Protected NCD add button
		And I click Injury Cover  add button
		And I click Legal Expenses  add button
		And I click Car Hire / Replacement Plus  add button
		And I click Comprehensive Drive Other Cars  add button
		And I click Update Quote button at the top of the page 
